...
function Estadisticas({ jugador }) {
    ...
    const handleResta = (key) => {
        setAccion((prevState) => {
            ...
            // Si 'roja' es 0 después de restar, establecer 'dosMinutos' a 2
            if (key === 'roja' && prevState[key] === 1 && prevState.dosMinutos === 3) {
                nuevosValores.dosMinutos = prevState.dosMinutos - 1;
            }
                ...
                <View style={[
                    ...
                    <View style={styles.statRow}>
                        <Text style={[
                            ...
                            Pases: {accion.pases} - Correctos: ({porcentajePases}%)
                        </Text>
                    </View>
                </View>
